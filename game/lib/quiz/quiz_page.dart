...
class _QuizScreenState extends State<_QuizScreen> {
    ...
    return Consumer<QuizModel>(
      builder: (context, quizModel, _) {
        ...
        if (quizModel.errorMessage != null &&
            quizModel.errorMessage!.toLowerCase().contains(
  ...
  Future<void> _showResultDialog(
    ...
    await showDialog(
                          ...
                          if (isCorrect) ...[
                            ...
                            RichText(
                              ...
                              text: TextSpan(
                                ...
                                children: [
                                  const TextSpan(
                                    text: 'The correct answer was ', // here
                                  ),
                                  TextSpan(
                              ...
                              style: ButtonStyle(
                                padding: MaterialStateProperty.all<
                                  ...
                                  EdgeInsets.symmetric(
                                    horizontal: (MediaQuery.devicePixelRatioOf(
                                              context,
                                            ) <
                                            3
                                        ? 6
      ...
      // Defer dispose until after widget tree cleanup is complete
      // to avoid "used after disposed" error from ConfettiWidget.dispose()
      WidgetsBinding.instance.addPostFrameCallback((_) {
