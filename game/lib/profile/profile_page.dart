          ...
          child: Consumer5<UserModel, EventModel, TrackerModel, ChallengeModel,
            ...
            for (var eventId in userModel.userData!.trackedEvents!) {
              ...
              try {
                ...
                completedEvents.add(Tuple3<DateTime, EventDto, int>(
                    date, event, totalHintsUsed));
              } catch (e) {
            ...
            return Column(
              children: [
                Stack(fit: StackFit.passthrough, children: [
                  Center(
                    child: Container(
                      ...
                      child: Stack(
                        alignment: Alignment
                            .center, // Central alignment within the stack
                        children: [
                          Positioned(
                            top: 0, // Adjust this value to move SVG up or down
                            child: SvgPicture.asset(
                                "assets/images/bear_prof.svg",
                                height: 100,
                                width: 100),
                          ),
                          Positioned(
                ...
                Padding(
                  padding:
                      const EdgeInsets.only(left: 28, right: 23.0, top: 14.0),
                  child: Row(
