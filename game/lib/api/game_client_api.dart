...
class GameClientApi {
  ...
  final _campusEventDetailsController =
      StreamController<CampusEventDetailsDto>.broadcast(sync: true);
  Stream<CampusEventDetailsDto> get campusEventDetailsStream =>
      _campusEventDetailsController.stream;
  ...
  void connectSocket(Socket sock) {
    ...
    sock.on(
        "campusEventDetails",
        (data) => _campusEventDetailsController
            .add(CampusEventDetailsDto.fromJson(data)));
