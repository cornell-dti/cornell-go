  ...
  class GameClientApi {
    ...
    void connectSocket(Socket sock) {
      ...
      sock.on(
        "updateChallengeData",
        (data) =>
            _updateChallengeDataController.add(UpdateChallengeDataDto.fromJson(data)));

    
      sock.on(
        "updateEventTrackerData",
        (data) =>
            _updateEventTrackerDataController.add(EventTrackerDto.fromJson(data)));
      ...
      sock.on(
        "updateLeaderData",
        (data) =>
            _updateLeaderDataController.add(UpdateLeaderDataDto.fromJson(data)));
      ...
      sock.on(
        ...
        (data) =>
            _updateOrganizationDataController.add(UpdateOrganizationDataDto.fromJson(data)));
