...
import { EntryForm, EntryModal, FreeEntryForm, NumberEntryForm, OptionEntryForm } from "./EntryModal";
...
function toForm(reward: RewardDto) {
  return [
    ...
    { name: "Is Achievment?", options: ["No", "Yes"], value: reward.isAchievement? 1: 0},
