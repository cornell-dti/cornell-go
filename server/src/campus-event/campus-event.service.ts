...
export class CampusEventService {
  ...
  async toCampusEventDto(
    ...
    return {
      ...
      categories: ev.categories as unknown as CampusEventCategoryDto[],
      tags: ev.tags,
      source: ev.source as unknown as EventSourceDto,
      externalUrl: ev.externalUrl ?? undefined,
      organizerName: ev.organizerName ?? undefined,
      registrationUrl: ev.registrationUrl ?? undefined,
      checkInMethod: ev.checkInMethod as unknown as CheckInMethodDto,
